"""
Django settings for frosty_sunset_dev_96177 project.
...
ROOT_URLCONF = 'frosty_sunset_dev_96177.urls'
...
WSGI_APPLICATION = 'frosty_sunset_dev_96177.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_sunset_dev_96177 API",
    "DESCRIPTION": "API documentation for frosty_sunset_dev_96177 App",
    "VERSION": "v1",
}
